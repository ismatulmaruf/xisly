  ...
  useEffect(() => {
    setIschanged(
      userInput.name !== userData?.fullName ||
        ...
        userInput.collage !== userData?.collage
    );
  }, [userInput, userData]);
    ...
    <Layout hideFooter={true}>
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh] dark:bg-gray-900">
        <form
          ...
          className="flex flex-col dark:bg-gray-800 relative gap-7 rounded-lg md:py-10 py-7 md:px-7 px-3 md:w-[750px] w-full shadow-custom dark:shadow-xl"
        >
          ...
          <div className="w-full flex flex-wrap gap-6">
            ...
            <InputBox
              ...
              name={"collage"}
              type={"text"}
              value={userInput.collage}
              onChange={(e) =>
                setUserInput({ ...userInput, collage: e.target.value })
              }
              className="md:w-[48%] w-[100%]"
            />
            <InputBox
